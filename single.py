"""Example running GMemN2N on a single bAbI task.
...
with tf.Session() as sess:
    model = GMemN2N(batch_size, vocab_size, sentence_size, memory_size, FLAGS.embedding_size, session=sess,
